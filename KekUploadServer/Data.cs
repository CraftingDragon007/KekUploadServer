...
{
    public static bool IsDataBaseCommandRunning = false;
    ...
    public static string GetVideoThumbnail(string videoPath, string id)
    {
        ...
        mediaConverter.OnCompleteEventHandler += (sender, args) =>
        {
            tcs.SetResult(true);
        };
    ...
    public static Metadata GetVideoMetadata(string videoPath)
    {
        ...
        metadataService.OnMetadataProcessedEventHandler += (sender, args) =>
        {
            tcs.TrySetResult(args.Metadata);
        };
    ...
    public static void InsertUploadedItemIntoDatabase(UploadItem item, string id)
    {
        ...
        while (IsDataBaseCommandRunning)
        {
            Thread.Sleep(100);
        }
